...
#define M 96
#define D 6
#define var_size M //vector_size //vector_size or M
#define var_amount 100 // amount //amount or 1
...
void PE_dotproduct  (   int const vector_size,
    ...
    for(int i=0; i<var_amount; i++) {
        ...
        loop2:
        for (int i=0; i< var_size / 16; i++) { // vector_size is ALWAYS a multiple of 16
